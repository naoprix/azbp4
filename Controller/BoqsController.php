...
class BoqsController extends AppController {//クラス名はテーブル名と整合をとること。
    
    public $helpers = array('Html', 'Form', 'Session');
    public $uses = array('Boq','Payment', 'Contract', 'User');


    public function index() {
        $boq = $this->Boq->find('all');//, array('order' => array('bill_no' => 'asc')));
        $this->set('boq',$boq);
    }
