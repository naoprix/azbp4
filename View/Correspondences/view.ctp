...
<p><?php echo $this->Html->link('<< Contract List', array('action' => 'index')); ?></p>
...
<p></p>
<p><?php echo $this->Html->link('Add Variaton Order Data', 
                      array('action' => 'add_vo', $contract['0']['Contract']['code'])); ?></p>
...
<p><?php if (AuthComponent::user()) {
            echo $this->Html->link('Add Correspondence Data',
                array('controller' => 'Correspondences', 'action' => 'add')); } ?></p>
