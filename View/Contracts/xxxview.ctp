...
<h2><?php //echo 'Contract No.: ',$contract['0']['Contract']['code']; ?></h2>
<h2><?php //echo 'Title: ',$contract['0']['Contract']['contract_name']; ?></h2>
<h2><?php //echo 'Contractor: ',$contract['0']['Contract']['contractor'];?></h2>
<h2><?php //echo 'Date of Contract Signing: ',$contract['0']['Contract']['date_sign'];?></h2>
<h2><?php //echo 'Date of Commencement: ',$contract['0']['Contract']['date_commencement'];?></h2>
